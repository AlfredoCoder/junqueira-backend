...
<AuditFile xmlns="urn:OECD:StandardAuditFile-Tax:AO_1.04_01">
  <Header>
    ...
    <CompanyName>${getDadosFatura().empresa.nome}</CompanyName>
    <BusinessName>${getDadosFatura().empresa.nome}</BusinessName>
    <CompanyAddress>
      <AddressDetail>${getDadosFatura().empresa.endereco}</AddressDetail>
      <City>Talatona</City>
...
router.get('/company-info', async (req, res) => {
  try {
    ...
    const companyInfo = {
      ...
      name: getDadosFatura().empresa.nome,
      businessName: getDadosFatura().empresa.nome,
      address: {
        addressDetail: getDadosFatura().empresa.endereco,
        city: 'Talatona',
        postalCode: '1000',
        region: 'Luanda',
        country: 'AO'
      ...
      contacts: {
        telephone: getDadosFatura().empresa.telefones.join(' | '),
        fax: '',
        email: getDadosFatura().empresa.email,
